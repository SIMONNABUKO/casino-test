          ...
          >
            <div class="card">
              ...
              <div class="card-body">
                ...
                <a href="#" class="btn btn-primary btn-sm px-3 mr-2" @click="openGame(game.id, 1)">demo</a>
                <a href="#" class="btn btn-success btn-sm px-3 mr-2" @click="openGame(game.id, 0)">play</a>
              </div>
            </div>
          </div>
        </div>
